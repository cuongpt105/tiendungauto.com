...
var HeaderInfoService = (function () {
    function HeaderInfoService() {
    }
    HeaderInfoService.prototype.getHeaderInfos = function () {
        return HEADER_INFOS;
    };
    HeaderInfoService.prototype.getHeaderInfoByName = function (name) {
        var result = this.getHeaderInfos().filter(function (item) {
            return (item.name === name);
        });
        return result ? result[0] : null;
    };
    HeaderInfoService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [])
    ], HeaderInfoService);
    return HeaderInfoService;
}());
exports.HeaderInfoService = HeaderInfoService;
//# sourceMappingURL=header-info.service.js.map